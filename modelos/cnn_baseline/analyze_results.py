...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Gera análise resumida do CSV consolidado da CNN baseline."
    )
    parser.add_argument("--csv", required=True)
    parser.add_argument(
        "--out-dir",
        default="reports/cnn/figures/consolidado",
    )
    ...
    save_top10_time_plot(
        ranking,
        output_path=out_dir / "top10_tempo_treinamento.png",
    )
