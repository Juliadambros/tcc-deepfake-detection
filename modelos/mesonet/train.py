...
from modelos.mesonet.evaluate import evaluate_checkpoint
...
def build_run_name(config: dict) -> str:
    prefix = config.get("run_prefix", "mesonet")
    return (
...
def train_single_run(config: dict) -> dict:
    ...
    # garante que a pasta principal do experimento exista
    ...
    # caso nenhuma época melhore por algum motivo, salva o último como melhor
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Treina uma configuração da MesoNet.")
